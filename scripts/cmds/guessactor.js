...
const f = c.join(__dirname, 'actor.json');
...
module.exports = {
  config: {
    ...
    author: "Kshitiz || gojo",
    role: 0,
    shortDescription: "Guess the movie actor",
    longDescription: "Guess the name of the movie actor",
    category: "game",
    guide: {
      en: "{p}aniquiz"
    }
...
`;
  ...
  fetchCharacterData: async function () {
    try {
      const k = await a.get('https://actorquiz.vercel.app/kshitiz');
      return k;
    } catch (error) {
